    ...
    <footer className="bg-blue-100 mt-10">
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Logo & About */}
          <div>
            <h2 className="text-blue-400 font-bold text-2xl">M-CORE</h2>
          ...
          <div>
            ...
            <div className="mt-3 flex">
              <input
                ...
                className="w-full px-3 py-2 rounded-l-md text-gray-700 border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
              />
              <button className="px-4 py-2 bg-blue-400 text-white rounded-r-md hover:bg-blue-600">
                Subscribe
              </button>
            </div>
          </div>
