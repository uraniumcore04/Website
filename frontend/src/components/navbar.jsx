          ...
          <div className="hidden lg:flex items-center space-x-1 xl:space-x-4">
            {navLinks.map((link) => (
              <a
                ...
                className={`relative px-3 py-2 text-base font-medium rounded-md transition-all duration-300 group ${
            ...
            <button className="ml-6 px-5 py-2.5 text-sm font-medium rounded-md text-white bg-blue-500 hover:bg-blue-600 transition-colors duration-300 shadow-sm hover:shadow transform hover:-translate-y-0.5">
              Login / Sign Up
            </button>
          </div>
